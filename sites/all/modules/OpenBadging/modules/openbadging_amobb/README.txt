...
openbadging-openbadges-backpack-button with div id 'title of badge' for example:

<div class='openbadging-openbadges-backpack-button' id='title of badge which you want to send to mozilla backpack'>
create link here
</div>  
